...
XPGT(Player1,2259999)~ THEN REPLY @1 GOTO 44
  IF ~InParty("Tapio")
XPLT("Tapio",3000000)
XPGT("Tapio",2259999)~ THEN REPLY @2 GOTO 47
  IF ~InParty("Wulfg2")
XPLT("Wulfg2",3000000)
XPGT("Wulfg2",2259999)~ THEN REPLY @3 GOTO 50
  IF ~InParty("Korgan")
XPLT("Korgan",3000000)
XPGT("Korgan",2259999)~ THEN REPLY @4 GOTO 53
  IF ~InParty("Mazzy")
XPLT("Mazzy",3000000)
XPGT("Mazzy",2259999)~ THEN REPLY @5 GOTO 56
  IF ~InParty("Brue2")
XPLT("Brue2",3000000)
XPGT("Brue2",2259999)~ THEN REPLY @6 GOTO 59
  IF ~~ THEN REPLY @7 EXIT
END
